  ...
  return (
    <div className="grid grid-rows-2 justify-center">
      ...
      <div className="flex gap-2 rounded-xl flex shadow-[0_0_10px_0px_rgba(0,0,0,0.1)]">
        <input type="text" placeholder="From" className="p-2 ml-0" onChange={handleFromChange}/>
        <Icon
          icon="proicons:arrow-swap"
          className="text-2xl mt-4 hover:cursor-pointer"
        />
        <input type="text" placeholder="To" className="p-2" onChange={handleToChange}/>
        <input type="text" placeholder="Departure" className="p-2 w-24" onChange={handleDepartureChange}/>
        <input type="text" placeholder="Return" className="p-2 w-20" onChange={handleReturnChange}/>
        <input type="text" placeholder="Travelers" className="p-2 w-24" onChange={handleTravelerChange}/>
        <button className="bg-blue-500 text-white py-2 px-4 rounded m-2 hover:bg-blue-600 hover:cursor-pointer" onClick={handleClick}>
          Search
        </button>
      </div>
    </div>
